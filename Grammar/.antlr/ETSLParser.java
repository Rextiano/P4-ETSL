...
public class ETSLParser extends Parser {
	...
	@SuppressWarnings("CheckReturnValue")
	public static class VarDeclActionContext extends ActionContext {
		public VarDeclContext varDecl() {
			return getRuleContext(VarDeclContext.class,0);
		}
		public VarDeclActionContext(ActionContext ctx) { copyFrom(ctx); }
	}
	@SuppressWarnings("CheckReturnValue")
	public static class ReturnActionContext extends ActionContext {
		public TerminalNode RET() { return getToken(ETSLParser.RET, 0); }
		public ExpressionContext expression() {
			return getRuleContext(ExpressionContext.class,0);
		}
		public ReturnActionContext(ActionContext ctx) { copyFrom(ctx); }
	}
	@SuppressWarnings("CheckReturnValue")
	public static class BlockActionContext extends ActionContext {
		public BlockContext block() {
			return getRuleContext(BlockContext.class,0);
		}
		public BlockActionContext(ActionContext ctx) { copyFrom(ctx); }
	}
	@SuppressWarnings("CheckReturnValue")
	public static class LogActionContext extends ActionContext {
		public TerminalNode LOG() { return getToken(ETSLParser.LOG, 0); }
		public ExpressionContext expression() {
			return getRuleContext(ExpressionContext.class,0);
		}
		public LogActionContext(ActionContext ctx) { copyFrom(ctx); }
	}
	@SuppressWarnings("CheckReturnValue")
	public static class IfActionContext extends ActionContext {
		...
		public IfActionContext(ActionContext ctx) { copyFrom(ctx); }
	}
	@SuppressWarnings("CheckReturnValue")
	public static class ExprActionContext extends ActionContext {
		public ExpressionContext expression() {
			return getRuleContext(ExpressionContext.class,0);
		}
		public ExprActionContext(ActionContext ctx) { copyFrom(ctx); }
	}
	@SuppressWarnings("CheckReturnValue")
	public static class SkipActionContext extends ActionContext {
		public TerminalNode SKIP_STMT() { return getToken(ETSLParser.SKIP_STMT, 0); }
		public SkipActionContext(ActionContext ctx) { copyFrom(ctx); }
	}
